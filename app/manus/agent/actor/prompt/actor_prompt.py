...
def actor_execute_task_prompt(task, step_index, plan):
    ...
    facts_preview = _truncate_for_prompt(plan.facts, int(os.getenv("ACTOR_FACTS_PROMPT_MAX_CHARS", "4500")))
    plan_preview = _truncate_for_prompt(plan.format(), int(os.getenv("ACTOR_PLAN_PROMPT_MAX_CHARS", "7000")))
