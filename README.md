...
本仓库是**QSeek**团队在 2026 天池 AI Research Agent 比赛中的解决方案，目标是构建一个面向复杂开放域检索问答任务的 Deep Research Agent。整体方案基于 MiroThinker的 Agent 框架思路继续迭代，并针对天池赛题的多跳检索、证据验证、跨语言实体规范化、长上下文稳定性和时限约束做了专项优化。
