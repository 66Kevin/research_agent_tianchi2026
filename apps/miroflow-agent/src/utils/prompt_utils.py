...
def generate_agent_summarize_prompt(task_description, agent_type=""):
    ...
    if agent_type == "main":
        summarize_prompt = (
            ...
            "- If the question is in Chinese and the answer entity is found in English, prefer the official Chinese full name or the standard Chinese translation when it is reliably supported by the conversation.\n"
            "- If the question is in English, prefer the official English full name.\n"
            "- If no reliable localized official name is available in the conversation, fall back to the official original full name.\n"
